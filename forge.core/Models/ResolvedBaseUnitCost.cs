...
/// <summary>
/// UoM purchase-options effort — the cost of one **base/stock unit** of a part, derived from the
/// preferred vendor's price tier divided by the chosen purchase option's content quantity
...
/// <param name="PurchaseOptionId">Which purchase option was used; null = a per-base-unit tier (legacy single option).</param>
