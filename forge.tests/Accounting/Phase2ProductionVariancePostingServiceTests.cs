...
public class Phase2ProductionVariancePostingServiceTests
{
    ...
    private static async Task SeedJobAsync(AppDbContext db, decimal materialIn, decimal stdFgRelieved, decimal labor, decimal burden)
    {
        ...
        {
            JobId = JobId, UserId = 7, Date = EntryDate, DurationMinutes = 60, LaborCost = labor, BurdenCost = burden,
        });
        await db.SaveChangesAsync();
    }
