...
public class CloudFolderAutoCreatorTests
{
    ...
    private static CloudFolderAutoCreator NewCreator(Forge.Data.Context.AppDbContext db)
    {
        ...
        var resolver = new CloudStorageResolver(
            new Forge.Core.Interfaces.ICloudStorageIntegrationService[] { mockProvider },
    ...
    private sealed class PassThroughTokenEncryptionService : Forge.Core.Interfaces.ITokenEncryptionService
    {
    ...
    private static async Task SeedFolderMapAsync(
        Forge.Data.Context.AppDbContext db,
