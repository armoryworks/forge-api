...
public class AppDbContext : IdentityDbContext<ApplicationUser, IdentityRole<int>, int>, IDataProtectionKeyContext
{
    ...
    public DbSet<Forge.Core.Entities.Accounting.AcctBudget> AcctBudgets => Set<Forge.Core.Entities.Accounting.AcctBudget>();
    ...
    public DbSet<PieceRate> PieceRates => Set<PieceRate>();
