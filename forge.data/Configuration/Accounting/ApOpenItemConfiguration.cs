...
public class ApOpenItemConfiguration : IEntityTypeConfiguration<ApOpenItem>
{
    public void Configure(EntityTypeBuilder<ApOpenItem> builder)
    {
        builder.ToTable("acct_ap_open_items");
