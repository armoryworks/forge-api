...
public class OperationConfiguration : IEntityTypeConfiguration<Operation>
{
    public void Configure(EntityTypeBuilder<Operation> builder)
    {
        ...
        builder.Property(e => e.IsSubcontract).HasDefaultValueSql("false");
        builder.Property(e => e.OverlapPercent).HasDefaultValueSql("0.0");
        builder.Property(e => e.RunMinutesEach).HasDefaultValueSql("0.0");
        builder.Property(e => e.RunMinutesLot).HasDefaultValueSql("0.0");
        builder.Property(e => e.ScrapFactor).HasDefaultValueSql("0.0");
        builder.Property(e => e.SetupMinutes).HasDefaultValueSql("0.0");
        builder.Property(e => e.BurdenRate).HasDefaultValueSql("0.0");
        ...
        builder.Property(e => e.LaborRate).HasDefaultValueSql("0.0");
