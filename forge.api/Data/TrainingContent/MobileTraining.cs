...
public class MobileTraining : TrainingContentBase
{
    ...
    public override async Task SeedAsync()
    {
        ...
        await GetOrCreateModule(new TrainingModule
        {
            ...
            AppRoutes = """["/app/scan"]""",
            Tags = """["mobile","quiz"]""",
            ContentJson = """{"passingScore": 80, "shuffleQuestions": false, "shuffleOptions": true, "showExplanationsAfterSubmit": true, "questions": [{"id": "q1", "text": "How does a person get the app connected to your Forge?", "options": [{"id": "q1a", "text": "They type a username and password into the app", "isCorrect": false}, {"id": "q1b", "text": "They scan a QR code an admin issued from Admin > Users", "isCorrect": true}, {"id": "q1c", "text": "They download it from the company website and it finds the server", "isCorrect": false}, {"id": "q1d", "text": "They email their phone number to IT", "isCorrect": false}], "explanation": "Enrollment is a one-phone, ten-minute QR code from Add a device. No password is ever typed on the phone."}, {"id": "q2", "text": "You moved the wrong job forward on your phone. What do you do?", "options": [{"id": "q2a", "text": "Tell a supervisor to fix it on the desktop", "isCorrect": false}, {"id": "q2b", "text": "Tap Undo on the blue bar within thirty seconds", "isCorrect": true}, {"id": "q2c", "text": "Scan the job again to move it back", "isCorrect": false}, {"id": "q2d", "text": "Restart the app", "isCorrect": false}], "explanation": "Every action offers Undo for thirty seconds; it moves the job straight back to the column it came from."}, {"id": "q3", "text": "The Wi-Fi drops while you are moving stock. What happens to what you did?", "options": [{"id": "q3a", "text": "It is lost — do it again when you are back online", "isCorrect": false}, {"id": "q3b", "text": "The app refuses to do anything until the signal returns", "isCorrect": false}, {"id": "q3c", "text": "It is saved on the phone and sent in order when the signal returns", "isCorrect": true}, {"id": "q3d", "text": "It is emailed to your admin", "isCorrect": false}], "explanation": "Actions queue on the phone with a count in the header and replay in order on reconnect; Undo still works on queued actions."}, {"id": "q4", "text": "A phone was lost on Friday. What does an admin do?", "options": [{"id": "q4a", "text": "Change the company Wi-Fi password", "isCorrect": false}, {"id": "q4b", "text": "Sign the phone out from the person's Add a device dialog", "isCorrect": true}, {"id": "q4c", "text": "Delete the person's user account", "isCorrect": false}, {"id": "q4d", "text": "Nothing — the phone locks itself after a day", "isCorrect": false}], "explanation": "Sign out cuts the phone off immediately and it erases its Forge data the next time it reaches the server."}, {"id": "q5", "text": "Your server's TLS certificate renews next week. What must happen first?", "options": [{"id": "q5a", "text": "Nothing — phones pick up the new certificate automatically", "isCorrect": false}, {"id": "q5b", "text": "Every phone must be re-enrolled after the renewal", "isCorrect": false}, {"id": "q5c", "text": "The new fingerprint goes into the server settings before the renewal", "isCorrect": true}, {"id": "q5d", "text": "Turn CAP-MOBILE-CORE off during the renewal", "isCorrect": false}], "explanation": "Phones pin the fingerprint. Set MOBILE_CERT_SHA256 to the new value before the certificate changes; otherwise every phone refuses to connect until re-enrolled."}]}"""
        });
    }
}
