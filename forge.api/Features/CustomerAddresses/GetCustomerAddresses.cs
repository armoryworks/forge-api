...
public record GetCustomerAddressesQuery(int CustomerId, bool IncludeInactive = false)
    : IRequest<List<CustomerAddressResponseModel>>;
    ...
    : IRequestHandler<GetCustomerAddressesQuery, List<CustomerAddressResponseModel>>
{
    ...
    {
        return await repo.GetByCustomerAsync(request.CustomerId, cancellationToken, request.IncludeInactive);
    }
}
